    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-responsive table-striped table-hover table_cus">
                ...
                <tbody>
                  <?php
                    $query = "SELECT * FROM `education` order by pass_year DESC";
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?php echo substr($value['details'],0,15); ?>....</td>
                        <td><?php echo substr($value['pass_year'],0,10); ?>....</td>
                        <td>
                            <a href="view-edu.php?v=<?= $value['id']; ?>"><i class="fa fa-plus-square fa-lg"></i></a>
